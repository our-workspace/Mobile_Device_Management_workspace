...
// =============================================
// تعريف جميع أنواع رسائل بروتوكول الـ WebSocket
// =============================================
...
export interface HeartbeatMessage extends BaseMessage {
  ...
  payload: {
    ...
    network: {
      ...
      isConnected: boolean;
      wifiSignalLevel: number | null; // 0-5
...
// Union type للرسائل الواردة من الـ Agent
...
// Union type للرسائل الصادرة للـ Agent
